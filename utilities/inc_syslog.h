...
#define SYSLOG_E(...)         (CMODULE_LOG_PRINTF("[E]") + CMODULE_LOG_PRINTF(SYSLOG_TAG) + CMODULE_LOG_PRINTF(": ") + CMODULE_LOG_PRINTF(__VA_ARGS__) + CMODULE_LOG_PRINTF(CMODULE_LOG_LINEFEED))
#else
#define SYSLOG_E(...)
#endif // SYSLOG_LVL_E

#if defined(SYSLOG_DEBUG) && (SYSLOG_LVL >= SYSLOG_LVL_W)
#define SYSLOG_W(...)         (CMODULE_LOG_PRINTF("[W]") + CMODULE_LOG_PRINTF(SYSLOG_TAG) + CMODULE_LOG_PRINTF(": ") + CMODULE_LOG_PRINTF(__VA_ARGS__) + CMODULE_LOG_PRINTF(CMODULE_LOG_LINEFEED))
#else
#define SYSLOG_W(...)
#endif // SYSLOG_LVL_E

#if defined(SYSLOG_DEBUG) && (SYSLOG_LVL >= SYSLOG_LVL_I)
#define SYSLOG_I(...)         (CMODULE_LOG_PRINTF("[I]") + CMODULE_LOG_PRINTF(SYSLOG_TAG) + CMODULE_LOG_PRINTF(": ") + CMODULE_LOG_PRINTF(__VA_ARGS__) + CMODULE_LOG_PRINTF(CMODULE_LOG_LINEFEED))
#else
#define SYSLOG_I(...)
#endif // SYSLOG_LVL_E

#if defined(SYSLOG_DEBUG) && (SYSLOG_LVL >= SYSLOG_LVL_D)
#define SYSLOG_D(...)         (CMODULE_LOG_PRINTF("[D]") + CMODULE_LOG_PRINTF(SYSLOG_TAG) + CMODULE_LOG_PRINTF(": ") + CMODULE_LOG_PRINTF(__VA_ARGS__) + CMODULE_LOG_PRINTF(CMODULE_LOG_LINEFEED))
#else
#define SYSLOG_D(...)
#endif // SYSLOG_LVL_E

#if defined(SYSLOG_DEBUG) && (SYSLOG_LVL >= SYSLOG_LVL_V)
#define SYSLOG_V(...)         (CMODULE_LOG_PRINTF("[V]") + CMODULE_LOG_PRINTF(SYSLOG_TAG) + CMODULE_LOG_PRINTF(": ") + CMODULE_LOG_PRINTF(__VA_ARGS__) + CMODULE_LOG_PRINTF(CMODULE_LOG_LINEFEED))
#else
#define SYSLOG_V(...)
#endif // SYSLOG_LVL_E
